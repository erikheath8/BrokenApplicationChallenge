...
namespace Pokemon_Repository
{
    ...
    public class Pokemon
    {
        ...
        public Pokemon(int teamPosition,string speciesName, string NickName, int level, PokemonType pokemonType,
            PokemonType secondaryType, string moveOne, string moveTwo, string moveThree, string moveFour)
        {
