    ...
    class ProgramUI
    {
        ...
        private void AddPokemonToTeam()
        {
            ...
            else
            {
                ...
                int pokeLevel = Convert.ToInt32(Console.ReadLine());
        ...
        private void UpdateAPokemon(teamPosition)
        {
            ...
            else
            {
                ...
                Pokemon newPokemon = new Pokemon(teamPosition, species, name, level, typeOne, typeTwo, moveOne,
                    moveTwo, moveThree, moveFour);
